...
void CCEGLViewProtocol::setFrameSize(float width, float height)
{
    ...
    else if (m_eResolutionPolicy != kResolutionUnKnown)
    {
...
void CCEGLViewProtocol::handleTouchesBegin(int num, long int ids[], float xs[], float ys[])
{
    CCSet set;
    for (int i = 0; i < num; ++i)
    {
...
void CCEGLViewProtocol::handleTouchesMove(int num, long int ids[], float xs[], float ys[])
{
    CCSet set;
    for (int i = 0; i < num; ++i)
    {
...
void CCEGLViewProtocol::getSetOfTouchesEndOrCancel(CCSet& set, int num, long int ids[], float xs[], float ys[])
{
    for (int i = 0; i < num; ++i)
    {
        long int id = ids[i];
...
void CCEGLViewProtocol::handleTouchesEnd(int num, long int ids[], float xs[], float ys[])
{
    CCSet set;
...
void CCEGLViewProtocol::handleTouchesCancel(int num, long int ids[], float xs[], float ys[])
{
    CCSet set;
    getSetOfTouchesEndOrCancel(set, num, ids, xs, ys);
