...
public:
    ...
    virtual void handleTouchesBegin(int num, long int ids[], float xs[], float ys[]);
    virtual void handleTouchesMove(int num, long int ids[], float xs[], float ys[]);
    virtual void handleTouchesEnd(int num, long int ids[], float xs[], float ys[]);
    virtual void handleTouchesCancel(int num, long int ids[], float xs[], float ys[]);
...
private:
    void getSetOfTouchesEndOrCancel(CCSet& set, int num, long int ids[], float xs[], float ys[]);
